    ...
    <body>
        <div class="navbar">
            <ul class="navmenu">
                ...
                <a href="./profiles.jsp" class="navitem active">Profiles</a>
                <%
                    String uname = null;
                    try{
        ...
        <div class="content">
            <div class="card card-lg">
                ...
                <a class="link" href="./experience.jsp">Lets Begin by reading computer science job interview experiences!</a>
            </div>
            ...
            <div class="card card-lg">
                ...
                <a class="link" href="./experience.jsp">Lets Begin by reading finance job interview experiences!</a>
            </div>
            ...
            <div class="card card-lg">
                ...
                <a class="link" href="./experience.jsp">Lets Begin by reading marketing job interview experiences!</a>
            </div>
