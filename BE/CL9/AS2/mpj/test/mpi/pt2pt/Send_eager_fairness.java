...
public class Send_eager_fairness {
  int DATA_SIZE = 100;

  public Send_eager_fairness() {
  }

  public Send_eager_fairness(String args[]) throws Exception {
    ...
    if (MPI.COMM_WORLD.Rank() == 0) {
      System.out.println("Send_eager_fairness TEST Completed");
    }
  ...
  public static void main(String args[]) throws Exception {
    Send_eager_fairness test = new Send_eager_fairness(args);
  }
}
