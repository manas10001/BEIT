...
public class BufferTest5 {
  public BufferTest5(String args[]) throws Exception {
    ...
    if (MPJDev.WORLD.id() == 0) {
      ...
      Buffer intBuffer = new Buffer(40 + 8);
      Buffer floatBuffer = new Buffer(40 + 8);
      Buffer doubleBuffer = new Buffer(72 + 8);
      Buffer shortBuffer = new Buffer(24 + 8);
      Buffer booleanBuffer = new Buffer(16 + 8);
